 ...
 * Description:
 */
public class ReadListFragment03 extends BaseFragment implements ReadListView{
    ...
    public void getReadListSuccess(final ReadingListEntity entity) {
        ...
        mAdapter = new ReadListAdapter03(getContext(),entity.getData().getQuestion());
        ...
        mAdapter.setOnItemClickLitener(new ReadListAdapter03.OnItemClickLitener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                intent.putExtra("id",entity.getData().getQuestion().get(position).getQuestion_id());
