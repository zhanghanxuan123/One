 ...
 * Description:
 */
public class ReadListAdapter03 extends RecyclerView.Adapter<ReadListAdapter03.ReadListViewHolder>{
    ...
    public ReadListAdapter03(Context context, List<ReadingListEntity.DataBean.QuestionBean>mDatas){
        mList = new ArrayList<>();
        this.mList = mDatas;
    ...
    @Override
    public ReadListAdapter03.ReadListViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.item_read,parent,false);
        return new ReadListViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final ReadListAdapter03.ReadListViewHolder holder, int position) {
        holder.tvUser_name.setText(mList.get(position).getAnswer_title());
        holder.tvHP_title.setText(mList.get(position).getQuestion_title());
        holder.tvGuide_word.setText(mList.get(position).getAnswer_content());
